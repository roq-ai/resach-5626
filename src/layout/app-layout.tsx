...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['administrator', 'teaching-assistant', 'content-creator'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Module', path: '/modules', entity: 'module', service: AccessServiceEnum.PROJECT, icon: FiLayers },
    {
